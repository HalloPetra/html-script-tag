(function(B,W){typeof exports=="object"&&typeof module<"u"?module.exports=W():typeof define=="function"&&define.amd?define(W):(B=typeof globalThis<"u"?globalThis:B||self,B.index=W())})(this,function(){"use strict";window.contactWidgetConfig=window.contactWidgetConfig||{},window.contactWidgetConfig.apiUrl=window.contactWidgetConfig.apiUrl||"https://api.hallopetra.de/api/web-widget/request-call",window.configureContactWidget=function(t){window.contactWidgetConfig={...window.contactWidgetConfig,...t}};function B(){const t=document.createElement("link");t.rel="preconnect",t.href="https://fonts.googleapis.com";const e=document.createElement("link");e.rel="preconnect",e.href="https://fonts.gstatic.com",e.crossOrigin="anonymous";const d=document.createElement("link");d.rel="stylesheet",d.href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap",document.head.appendChild(t),document.head.appendChild(e),document.head.appendChild(d);const g=document.createElement("style");g.innerHTML=`
    .contact-widget-btn {
      position: fixed;
      bottom: 20px;
      right: 20px;
